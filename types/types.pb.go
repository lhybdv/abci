...
const (
	...
	MessageType_SetValidators MessageType = 24
)
...
type Request_SetValidators struct {
	SetValidators *RequestSetValidators `protobuf:"bytes,12,opt,name=set_validators,json=setValidators,oneof"`
}
...
func (*Request_SetValidators) isRequest_Value() {}
...
func (m *Request) GetSetValidators() *RequestSetValidators {
	if x, ok := m.GetValue().(*Request_SetValidators); ok {
		return x.SetValidators
	}
	return nil
}
...
func _Request_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Request_SetValidators:
		b.EncodeVarint(12<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.SetValidators); err != nil {
			return err
		}
	case nil:
	default:
...
func _Request_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 11: // value.end_block
		...
		return true, err
	case 12: // value.set_validators
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(RequestSetValidators)
		err := b.DecodeMessage(msg)
		m.Value = &Request_SetValidators{msg}
		return true, err
	default:
		return false, nil
	}
...
type RequestSetValidators struct {
	Validators []*Validator `protobuf:"bytes,1,rep,name=validators" json:"validators,omitempty"`
}

func (m *RequestSetValidators) Reset()                    { *m = RequestSetValidators{} }
func (m *RequestSetValidators) String() string            { return proto.CompactTextString(m) }
func (*RequestSetValidators) ProtoMessage()               {}
func (*RequestSetValidators) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }

func (m *RequestSetValidators) GetValidators() []*Validator {
	if m != nil {
		return m.Validators
	}
	return nil
...
type Response_SetValidators struct {
	SetValidators *ResponseSetValidators `protobuf:"bytes,13,opt,name=set_validators,json=setValidators,oneof"`
}
...
func (*Response_SetValidators) isResponse_Value() {}
...
func (m *Response) GetSetValidators() *ResponseSetValidators {
	if x, ok := m.GetValue().(*Response_SetValidators); ok {
		return x.SetValidators
	}
	return nil
}
...
func _Response_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 12: // value.end_block
		...
		return true, err
	case 13: // value.set_validators
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ResponseSetValidators)
		err := b.DecodeMessage(msg)
		m.Value = &Response_SetValidators{msg}
		return true, err
	default:
		return false, nil
	}
...
type ResponseSetValidators struct {
}

func (m *ResponseSetValidators) Reset()                    { *m = ResponseSetValidators{} }
func (m *ResponseSetValidators) String() string            { return proto.CompactTextString(m) }
func (*ResponseSetValidators) ProtoMessage()               {}
func (*ResponseSetValidators) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{25} }
...
func init() {
	...
	proto.RegisterType((*RequestSetValidators)(nil), "types.RequestSetValidators")
...
type ABCIApplicationClient interface {
	...
	SetValidators(ctx context.Context, in *RequestSetValidators, opts ...grpc.CallOption) (*ResponseSetValidators, error)
}
...
func (c *aBCIApplicationClient) SetValidators(ctx context.Context, in *RequestSetValidators, opts ...grpc.CallOption) (*ResponseSetValidators, error) {
	out := new(ResponseSetValidators)
	err := grpc.Invoke(ctx, "/types.ABCIApplication/SetValidators", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ABCIApplicationServer interface {
	...
	SetValidators(context.Context, *RequestSetValidators) (*ResponseSetValidators, error)
}
...
func _ABCIApplication_SetValidators_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestSetValidators)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIApplicationServer).SetValidators(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/types.ABCIApplication/SetValidators",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIApplicationServer).SetValidators(ctx, req.(*RequestSetValidators))
	}
	return interceptor(ctx, in, info, handler)
}
