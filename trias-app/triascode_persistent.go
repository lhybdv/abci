...
func NewPersistentTriasCodeApplication(dbDir string) *PersistentTriasCodeApplication {
	...
	return &PersistentTriasCodeApplication{
		app:    &TriasCodeApplication{state: stateTree},
		db:     db,
...
func (app *PersistentTriasCodeApplication) Query(reqQuery types.RequestQuery) types.ResponseQuery {
...
func (app *PersistentTriasCodeApplication) execValidatorTx(tx []byte) types.Result {
...
func (app *PersistentTriasCodeApplication) updateValidator(v *types.Validator) types.Result {
